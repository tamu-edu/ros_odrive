...
ODriveCanNode::ODriveCanNode(const std::string& node_name) : rclcpp::Node(node_name) {
    ...
    this->declare_parameter<bool>("set_values_from_config", false);
        ...
        case CmdId::kTxSdo: {
            ...
            switch (value_access_datatype_specifier_) {
                ...
                case 1: {
                    ...
                    value_access_reponse_.float_value   = read_le<float>(frame.data + 4);
                    break;
                ...
                case 2: {
                    ...
                    value_access_reponse_.uint_value   = read_le<uint64_t>(frame.data + 4);
                    break;
...
void ODriveCanNode::service_callback(const std::shared_ptr<AxisState::Request> request, std::shared_ptr<AxisState::Response> response) {
    ...
    fresh_heartbeat_.wait(guard, [this, &call_time, &request]() {
        bool is_busy = this->ctrl_stat_.procedure_result == 1;
        bool requested_closed_loop = request->axis_requested_state == 8;
            ...
            if(request->opcode == 0){
                ...
                switch (value_access_datatype_specifier_) {
                    ...
                    case 1: {
                        ...
                        write_le<float>(request->float_value,   frame.data + 4);
                        break;
                    ...
                    case 2: {
                        ...
                        write_le<int32_t>(request->uint_value,   frame.data + 4);
                        break;
                    ...
                    case 3: {
                        ...
                        write_le<uint64_t>(request->uint_value,   frame.data + 4);
                        break;
                    ...
                    case 5: {
                        ...
                        write_le<uint16_t>(request->uint_value,   frame.data + 4);
                        break;
                    ...
                    case 6: {
                        ...
                        write_le<uint8_t>(request->uint_value,   frame.data + 4);
                        break;
